...
(0, _helpers.describeWithDOM)('mount', function () {
  ...
  describe('.mount()', function () {
    it('should call componentWillUnmount()', function () {
      var willMount = _sinon2.default.spy();
      var didMount = _sinon2.default.spy();
      var willUnmount = _sinon2.default.spy();
      ...
      var Foo = function (_React$Component7) {
        ...
        function Foo(props) {
          ...
          _this7.componentWillUnmount = willUnmount;
          _this7.componentWillMount = willMount;
          _this7.componentDidMount = didMount;
          return _this7;
        }
      ...
      var wrapper = (0, _.mount)(_react2.default.createElement(Foo, { id: 'foo' }));
      (0, _chai.expect)(willMount.callCount).to.equal(1);
      (0, _chai.expect)(didMount.callCount).to.equal(1);
      (0, _chai.expect)(willUnmount.callCount).to.equal(0);
      wrapper.unmount();
      (0, _chai.expect)(willMount.callCount).to.equal(1);
      (0, _chai.expect)(didMount.callCount).to.equal(1);
      (0, _chai.expect)(willUnmount.callCount).to.equal(1);
      wrapper.mount();
      (0, _chai.expect)(willMount.callCount).to.equal(2);
      (0, _chai.expect)(didMount.callCount).to.equal(2);
      (0, _chai.expect)(willUnmount.callCount).to.equal(1);
    });
  });
    ...
    it('should call componentWillUnmount()', function () {
      ...
      var Foo = function (_React$Component8) {
        ...
        function Foo(props) {
          ...
          _this8.componentWillUnmount = spy;
          return _this8;
        }
    ...
    it('should simulate events', function () {
      var Foo = function (_React$Component9) {
        ...
        function Foo(props) {
          ...
          var _this9 = _possibleConstructorReturn(this, Object.getPrototypeOf(Foo).call(this, props));

          _this9.state = { count: 0 };
          _this9.incrementCount = _this9.incrementCount.bind(_this9);
          return _this9;
        }
  ...
  describe('.setState(newState)', function () {
    it('should set the state of the root node', function () {
      var Foo = function (_React$Component13) {
        ...
        function Foo(props) {
          ...
          var _this13 = _possibleConstructorReturn(this, Object.getPrototypeOf(Foo).call(this, props));

          _this13.state = { id: 'foo' };
          return _this13;
        }
    ...
    it('allows setState inside of componentDidMount', function () {
      ...
      var MySharona = function (_React$Component14) {
        _inherits(MySharona, _React$Component14);

        function MySharona(props) {
          _classCallCheck(this, MySharona);

          var _this14 = _possibleConstructorReturn(this, Object.getPrototypeOf(MySharona).call(this, props));

          _this14.state = { mounted: false };
          return _this14;
        }
  ...
  describe('.html()', function () {
    ...
    it('should render out nested composite components', function () {
      var Foo = function (_React$Component22) {
        _inherits(Foo, _React$Component22);
      ...
      var Bar = function (_React$Component23) {
        _inherits(Bar, _React$Component23);
  ...
  describe('.render()', function () {
    it('should return a cheerio wrapper around the current node', function () {
      ...
      var wrapper = (0, _.mount)(_react2.default.createElement(Bar, null));
      (0, _chai.expect)(wrapper.render().find('.in-foo')).to.have.length(1);
    });
  });

  describe('attachTo option', function () {
    it('should attach and stuff', function () {
      ...
      (0, _chai.expect)(document.body.childNodes).to.have.length(1);
      (0, _chai.expect)(div.childNodes).to.have.length(0);

      var wrapper = (0, _.mount)(_react2.default.createElement(Foo, null), { attachTo: div });

      (0, _chai.expect)(wrapper.find('.in-foo')).to.have.length(1);
      (0, _chai.expect)(document.body.childNodes).to.have.length(1);
      (0, _chai.expect)(div.childNodes).to.have.length(1);
      ...
      (0, _chai.expect)(document.body.childNodes).to.have.length(0);
      (0, _chai.expect)(div.childNodes).to.have.length(0);
    });

    it('should allow for multiple attaches/detaches on same node', function () {
      var Foo = function (_React$Component27) {
        _inherits(Foo, _React$Component27);
      ...
      var Bar = function (_React$Component28) {
        _inherits(Bar, _React$Component28);
        ...
        _createClass(Bar, [{
          ...
          value: function () {
            function render() {
              return _react2.default.createElement('section', { className: 'in-bar' });
            }
      ...
      wrapper = (0, _.mount)(_react2.default.createElement(Foo, null), { attachTo: div });
      ...
      wrapper = (0, _.mount)(_react2.default.createElement(Bar, null), { attachTo: div });

      (0, _chai.expect)(wrapper.find('.in-bar')).to.have.length(1);
      (0, _chai.expect)(document.body.childNodes).to.have.length(1);
      (0, _chai.expect)(div.childNodes).to.have.length(1);
    ...
    it('will attach to the body successfully', function () {
      var Bar = function (_React$Component29) {
        _inherits(Bar, _React$Component29);
      ...
      var wrapper = (0, _.mount)(_react2.default.createElement(Bar, null), { attachTo: document.body });
